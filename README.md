...
* [`Most Recently Used (MRU) file manager`](https://github.com/BionicCode/BionicLibraryNet#MRU (Most Recently Used) file manager) - API that maintains an MRU table stored in the Application Settings file. 
