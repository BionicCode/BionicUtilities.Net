...
namespace BionicCode.BionicUtilities.Net.Uwp.Dialog
{
  ...
  public interface IDialogViewModel : IBaseViewModel
  {
    ...
    /// <summary>
    /// The <see cref="Uwp.Dialog.DialogResult"/> of the user interaction.
    /// </summary>
    ...
    /// <summary>
    /// ICommand that can be bound to the buttons of the dialog. The command parameter is a <see cref="Uwp.Dialog.DialogResult"/>.
    /// </summary>
